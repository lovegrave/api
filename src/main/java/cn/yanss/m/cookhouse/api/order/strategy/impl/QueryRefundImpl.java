...
@Component
public class QueryRefundImpl extends QueryOrder {

    @Autowired
    public QueryRefundImpl(EhCacheServiceImpl ehCacheService, RedisService redisService) {
    ...
    public List<Object> list(Object obj) {
        ...
        Set<String> orders = redisService.zrange(Const.REFUND + orderRequest.getStoreId() + orderRequest.getRefundType(), start, end);
